...
FKPOLIZAANTERIOR NUMBER(10,0) DEFAULT NULL,
FKCOTIZACION7 NUMBER(10,0) NOT NULL,
FKPAGOSEGURO NUMBER(10,0) NOT NULL,
FKSINIESTRO1 NUMBER(10,0) DEFAULT NULL,
FECHAINICIO DATE,
...
FKSOCIAL1  NUMBER(10,0) DEFAULT NULL,
FKCOLISION1 NUMBER(10,0) DEFAULT NULL,
FKMATERIAL1 NUMBER(10,0)  DEFAULT NULL,
FECHA DATE,
HORA NUMBER(2,0),
...
FKASEGURADORA2 NUMBER(10,0) DEFAULT NULL,
...
FKPERSONAAFECTADA2 NUMBER(10,1) DEFAULT NULL,
FKAUTOINVOLUCRADO2 NUMBER(10,0) DEFAULT NULL, --no todos los da;os materiales son a personas o autos
...
ALTER TABLE PERSONAAFECTADA ADD
  ...
  -- Creación de Foreign Keys y Extras

ALTER TABLE CLIENTE ADD
  CONSTRAINT FKCOTIZACION1
  FOREIGN KEY (FKCOTIZACION1)
  REFERENCES COTIZACION(IDCOTIZACION);

ALTER TABLE CLIENTE ADD
  CONSTRAINT FKFOLIO1
  FOREIGN KEY (FKFOLIO1)
...
ALTER TABLE TABULADOR ADD
  CONSTRAINT FKDUAL
  FOREIGN KEY (FKDUAL)
  REFERENCES DUAL(IDDUAL);



ALTER TABLE DUAL ADD
  CONSTRAINT FKTABULADOR6
  FOREIGN KEY (FKTABULADOR6)
  REFERENCES TABULADOR(IDTABULADOR);

ALTER TABLE DUAL ADD
  CONSTRAINT COSTOANUAL
  CHECK(COSTOANUAL=(FKTABULADOR6*1000));
